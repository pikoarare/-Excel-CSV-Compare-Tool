...
- Works even if row order differs  
- Automatically aligns columns  
- Supports Excel and CSV output  
...
This tool allows you to compare two Excel or CSV files and extract differences.

- Added rows
- Removed rows
- Changed values

ExcelやCSVファイルを比較し、差分（追加・削除・変更）を抽出できるツールです。

## How to Use

1. Select File A and File B  
2. Choose a key column  
3. Run comparison  
...
👉 https://gumroad.com/products/jwahl

## Notes

- Header row is required  
- Key column should be unique  
- May not work in OneDrive or protected folders  

## 注意事項

- ヘッダー行が必要です  
- キー列は一意であることを推奨します  
- OneDrive等では動作しない場合があります  
